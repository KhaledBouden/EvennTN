        ...
        <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-0">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav m-auto py-4">
                    ...
                    <a href="guard.html" class="nav-item nav-link active">Produits</a>
                    ...
                    <a href="contact.html" class="nav-item nav-link">Réclamation</a>
                </div>
            </div>
        </nav>
    </div>
            ...
            <div class="">
                ...
                <div class="row  align-items-center">
                    <div class="col-6 text-right">
                        ...
                        <p></p>
                        <a href="tables.php"><h6 class="text-primary font-weight-normal mb-2"  > <i class="fa-solid fa-user"></i> Admin</h6></a>
                    </div>
                    <div class="col-6">
