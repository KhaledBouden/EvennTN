...
include_once '../config.php';
    ...
    if (
        ...
        if (
            ...
            $reclamation->ajouterreclamation($reclamation);
...
?>
                  ...
                  <!--  <form name="sentMessage" id="contactForm" novalidate="novalidate">-->
                        <div class="control-group">
                            <input type="number" class="form-control" id="id" placeholder="id" required="required" data-validation-required-message="Please enter your id" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="date" class="form-control" id="date" placeholder="Your date" required="required" data-validation-required-message="Please enter your date" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control" id="objet" placeholder="objet" required="required" data-validation-required-message="Please enter a objet" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <textarea class="form-control" rows="6" id="description" placeholder="description" required="required" data-validation-required-message="Please enter your description"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
                            <button class="btn btn-primary" type="submit" id="sendMessageButton">Envoyer reclamation</button>
                        </div>
                        </form>
                    </form>
                    <?php /* if($s==1)
