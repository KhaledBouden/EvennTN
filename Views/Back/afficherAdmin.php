                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?PHP
                            ...
                            $adminC = new adminC();
                            $listeAdmins = $adminC->pagination($page, $perpage);
                            $totalP = $adminC->calcTotalRows($perpage);
                            ...
                            if(isset($_GET['recherche']))
                            {
                                ...
                                $listeAdmins=$adminC->recherche($search_value);
                            }
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Email</th>
                                                    <th colspan="2">
                                                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="afficherAdmin.php">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a  class="btn btn-primary" href="modifierAdmin.php?id=<?PHP echo $row['id']; ?>"> Modifier </a>
                                                    </td>
                                                </tr>
