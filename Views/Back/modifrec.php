...
<head>
    ...
    <title>Admin View reclamation</title>
            ...
            <div class="container-fluid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="objet" id="objet"  value="<?PHP echo isset($reclamation['objet']); ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="description">description</label>
                            <input type="text" class="form-control" name="description" id="description" value="<?PHP echo isset($reclamation['description']); ?>" required>
                        </div>
