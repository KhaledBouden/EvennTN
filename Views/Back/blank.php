...
<button><a href="../Front/security-guard-website-template/ajouter.php"   > Front</a></button>
...
<div style = "position:relative; left:780px; top:-75px;  ">
        ...
        <form method="get" action="blank.php">
                ...
                <a   href="affichierrepadmin.php "  class="btn btn-primary"   > Affichier les reponses</a>
           </form>
