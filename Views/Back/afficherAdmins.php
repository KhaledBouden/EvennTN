...
<!DOCTYPE html>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?PHP
                            ...
                            $userC = new userC();
                            $listeUsers = $userC->paginationAdmins($page, $perpage);
                            ...
                            if(isset($_GET['recherche']))
                            {
                                ...
                                $listeUsers=$userC->recherche($search_value);
                            }

                            //trie
                            if(isset($_GET['trie']))
                            {
                                $listeUsers = $userC->triCroissant($page, $perpage);
                            }
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Email</th>
                                                    <th colspan="2">
                                                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="afficherAdmins.php">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control bg-light border-0 small" placeholder="Rechercher un admin"
                                                    ...
                                                    <th>
                                                        <form method="get" action="afficherAdmins.php">
                                                            <button type="submit" class="btn btn-primary" name="trie">affichage</button>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a  class="btn btn-primary" href="modifierUser.php?id=<?PHP echo $row['id']; ?>"> Modifier </a>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
         ...
         $fire = mysqli_query($con,$sql);
          while ($result = mysqli_fetch_assoc($fire)) {
            echo"['".$result['id_infos']."',".$result['age']."],";
          }
        ...
        var options = {
          title: 'Tranche "Age" des Clients suivant leur ID'
        };
