                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" action="">
                    <div class="col-12">
                      ...
                      <input type="text" name="Nom" class="form-control"  required id="Nom" value="<?php echo $nom; ?>">
                    </div>
                    <div class="col-12">
                      <label for="yourName" class="form-label">Prix</label>
                      <input type="text" name="Prix" class="form-control"  required id="Prix" value="<?php echo $Prix; ?>">
                    </div>
                    <div class="col-12">
                      <label for="yourName" class="form-label">Qantité</label>
                      <input type="text" name="Quantite" class="form-control" required id="Quantite" value="<?php echo $Quantite; ?>">
                    </div>
