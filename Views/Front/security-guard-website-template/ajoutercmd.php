            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4" style="color: red;">Ajouter une commande pour le produit <?php echo $nom;  ?> avec l'id<?php echo $id;  ?><center><h4 style="color: red;"> </h4</center></h5>
                    
                  </div>

                  <form class="row g-3 needs-validation" method="post" action="">
                    <div class="col-12">
                      <label for="yourName" required  class="form-label">Nom</label>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" required name="num" class="form-control" id="num" >
                    </div>

                    <div class="col-12">
                      <label for="yourName" class="form-label">numc</label>
                      <input type="text" required name="numc" class="form-control" id="numc" >
                    </div>
