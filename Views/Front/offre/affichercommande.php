<?php
	...
	$listecommande=$commandeC->afficherListecommande(); 
?>
<!DOCTYPE html>
<html lang="en">
...
<table class="table table-striped table-white">
  ...
  <?php
    ...
    <tr>
      <th scope="row"><?php echo($commande['id_commande'] )?></th>
      ...
      <td> 
          ...
          <div class="col-xs-4">
           <form method="GET" action="modifiercommande.php">
						...
						<input type="hidden" name="id_commande" id=id_commande value=<?PHP echo $commande['id_commande']; ?>>
					</form>
                      </div>
                      <div class="col-xs-6">
                      <a class="btn btn-danger" href="supprimercommande.php?id_commande=<?php echo $commande['id_commande']; ?>">Supprimer</a>
                      </div>
            </td>
    </tr>
    </div> 
...
<div align="center">
    <a class="btn btn-success" href="ajoutercommande.php">Ajouter</a>
    <a class="btn btn-info" href="afficheroffrevendu.php">afficher les offres vendu</a>
 </div>
